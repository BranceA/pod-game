...
// This is probably going to end up being 95% of our code. It checks whatRoomWeIn and based on what room we in, it will
// check the nested conditionals. When you add commands to Go places, make sure to change the room variable.

// The else if statements are meant to be mass copy/pasted. The bottom of 'tutorial' has examples of default text, if
// the player doesn't use 2 keywords.

// Use variables to keep track of the state of the room.
// Such as whether a button has been pressed or not. You can use inventory.includes to check to see if the player has
// the required item or availableActions.includes to see if they have the required action.

//This function converts player input to lowercase and checks to see if its an index of the required command to progress.
// Mainly a way to clean up the code and make it more readable.
...
function checkKeyWords() {
    ...
    if (whatRoomWeIn === 'pageload') {
        if (decidedOnTutorial === false && checkText(checkThisText, "no")) {
            $(".big-text").hide().html("Things could always be worse. Sure life hasn't been great lately. Five years ago " +
                "the Dark Wizard Leslie, took over the world and reshaped it into a twisted hellscape. It was pretty " +
                "unfortunate when Emperor Leslie the Terrible and Great, set up his Fortress of Power down the street " +
                "from your house. Crime went down due to the tyrannical nature of Leslie but he also needs a never ending " +
                "supply of humans to sacrifice to evil forces better left alone. That's where you come in. You were " +
                "knocked out and when you woke up, you were tied right here on the ground with the sound of chanting. " +
                "It doesn't take a genius to realize that you were the next sacrifice on the docket. Something caused an " +
                "explosion and there was some screaming and now you seem to be by yourself. Like I said, things could be " +
                "worse. You have been pulling on your restraints for a while and you finally get loose. To get a better " +
                "idea of what is going on, you should <em>stand up</em>").fadeIn(800);
        ...
        if (checkText(checkThisText, 'look') && checkText(checkThisText, 'door')) {
            ...
            $(".big-text").hide().html("You turn around and see nothing. When I say nothing, I truly mean nothing. If " +
                "you picture the empty void of space, you still picture a black void. You don't even see a black void, " +
                "you see nothing. Your mind turns somersaults as it comes to terms with experiencing true nonexistence. " +
                "ABANDON ALL HOPE YE WHO ENTER HERE!").fadeIn(800);
            ...
            $(".big-text").hide().html("Things could always be worse. Sure life hasn't been great lately. Five years ago " +
                "the Dark Wizard Leslie, took over the world and reshaped it into a twisted hellscape. It was pretty " +
                "unfortunate when Emperor Leslie the Terrible and Great, set up his Fortress of Power down the street " +
                "from your house. Crime went down due to the tyrannical nature of Leslie but he also needs a never " +
                "ending supply of humans to sacrifice to evil forces better left alone. That's where you come in. You " +
                "were knocked out and when you woke up, you were tied right here on the ground with the sound of chanting. " +
                "It doesn't take a genius to realize that you were the next sacrifice on the docket. Something caused an " +
                "explosion and there was some screaming and now you seem to be by yourself. Like I said, things could be " +
                "worse. You have been pulling on your restraints for a while and you finally get loose. To get a better " +
                "idea of what is going on, you should <em>stand up</em>.").fadeIn(800);
            ...
            $(".big-text").hide().html("You fiddle with it but without an instruction manual, you're not sure how to use it.").fadeIn(800);
            ...
            $(".big-text").hide().html("This room is identical to the one you came from except there is a <em>button</em> " +
                "next to the <em>door</em>. The button is covered by <em>glass</em> and there is a <em>hammer</em> next " +
                "to it.").fadeIn(800);

        } else if (checkThisText.toLowerCase().indexOf('look') !== -1 && didHammerGetGot === true && isGlassSmashed === false) {

            $(".big-text").hide().html("This room is identical to the one you came from except there is a <em>button</em> " +
                "next to the <em>door</em>. The button is covered by <em>glass</em> and there was a <em>hammer</em> next to it.").fadeIn(800);
            ...
            $(".big-text").hide().html("I'm telling you almost exactly what to do. Type <em>look</em> and try to get " +
                "your bearings").fadeIn(800);
        ...
        if (checkText(checkThisText, 'wololo')) {
            ...
            $(".big-text").hide().html("Things could always be worse. Sure life hasn't been great lately. Five years " +
                "ago the Dark Wizard Leslie, took over the world and reshaped it into a twisted hellscape. It was " +
                "pretty unfortunate when Emperor Leslie the Terrible and Great, set up his Fortress of Power down the " +
                "street from your house. Crime went down due to the tyrannical nature of Leslie but he also needs a " +
                "never ending supply of humans to sacrifice to evil forces better left alone. That's where you come in. " +
                "You were knocked out and when you woke up, you were tied right here on the ground with the sound of " +
                "chanting. It doesn't take a genius to realize that you were the next sacrifice on the docket. Something " +
                "caused an explosion and there was some screaming and now you seem to be by yourself. Like I said, " +
                "things could be worse. You have been pulling on your restraints for a while and you finally get loose. " +
                "To get a better idea of what is going on, you should <em>stand up</em>").fadeIn(800);

            skipToCenter();

        } else if (checkText(checkThisText, 'stand') && checkText(checkThisText, 'up') && didStandUp === false) {

            $(".big-text").hide().html("Sweet freedom. You take in your surroundings as you stretch. You are in a room " +
                "with a bare stone floor and the <em>wall</em>s are covered in some kind of symbols. All things " +
                "considered, this place doesn't seem too bad. The epicenter of dark magic is sparsely furnished. The " +
                "only really disturbing thing in here is a shrunken <em>head</em> that is hanging from the ceiling. The " +
                "center of the room is clear and you are standing in a red <em>circle</em> painted on the ground. There " +
                "is a <em>podium</em> facing towards you. Near the <em>podium</em>, a <em>staff</em> is laying on the " +
                "ground and the area surrounding the <em>staff</em> is blackened. The directions leading out are " +
                "<em>east</em> and <em>west</em>. There is a <em>TBD barrier</em> to the <em>north</em> and " +
            ...
            $(".big-text").hide().html("You think about doing that and it seems like a good idea. The first step towards " +
                "accomplishing that is to <em>stand up</em>.").fadeIn(800);

        } else if (checkThisText.toLowerCase().indexOf('look') !== -1 && checkThisText.toLowerCase().indexOf('wall') !== -1) {

            $(".big-text").hide().html("Looking at the <em>wall</em> you see that it is made of dirt. Wherever you are, " +
                "it's likely underground. The symbols on the wall are a deep red and glowing faintly. It's nothing you " +
                "want to understand and they give you the creeps.").fadeIn(800);

        } else if (checkThisText.toLowerCase().indexOf('get') !== -1 && checkThisText.toLowerCase().indexOf('wall') !== -1) {

            $(".big-text").hide().html("I guess it is made of dirt. You scrape off some wall and put it in your pocket. " +
                "You feel like a more complete person.").fadeIn(800);

        } else if (checkThisText.toLowerCase().indexOf('use') !== -1 && checkThisText.toLowerCase().indexOf('wall') !== -1) {

            $(".big-text").hide().html("Use it how? The <em>wall</em>'s entire purpose is to be a barrier between two " +
                "places. It's is currently fulfilling it's mission.").fadeIn(800);
            ...
            $(".big-text").hide().html("There is a five pointed star on the inside of a <em>circle</em> large enough for " +
                "you to lay down in. An unlit candle is at each point of the star. It's understandably uncomfortable " +
                "standing here so you pretend to be someplace nice. A place called not here.").fadeIn(800);

        } else if (checkThisText.toLowerCase().indexOf('get') !== -1 && checkThisText.toLowerCase().indexOf('circle') !== -1) {

            $(".big-text").hide().html("It's a circle painted on the ground. You cannot acquire a two dimensional shape " +
                "painted on the ground.").fadeIn(800);

        } else if (checkThisText.toLowerCase().indexOf('use') !== -1 && checkThisText.toLowerCase().indexOf('circle') !== -1) {

            $(".big-text").hide().html("You know nothing of magic. Even if you knew how to use the circle, it probably " +
                "isn't a good idea.").fadeIn(800);

        } else if (checkText(checkThisText, 'go') && checkText(checkThisText, 'circle')) {

            $(".big-text").hide().html("You had wandered away from the circle. You return to the closest thing you have " +
                "to a home in this place.").fadeIn(800);

        } else if (checkText(checkThisText, 'look') && checkText(checkThisText, 'west')) {

            $(".big-text").hide().html("There is a wooden door to the <em>west</em>. You swear that you can hear " +
                "breathing coming from the other side.").fadeIn(800);
            ...
            $(".big-text").hide().html("That's a direction. I've had to delete five different responses because I don't " +
                "know how to deal to this.").fadeIn(800);

        } else if (checkText(checkThisText, 'look') && checkText(checkThisText, 'east') && eastKeyStatus === "under") {

            $(".big-text").hide().html("This wooden door appears to be locked. There must be a key somewhere in this " +
                "dungeon.").fadeIn(800);

        } else if (checkText(checkThisText, 'fish') && checkText(checkThisText, 'circle') && fishingPoleStatus === "none") {

            $(".big-text").hide().html("What? Are you mad? Being underground for so long absolutely has messed with your " +
                "head. How could this even be possible? Sounds like magic of some sort.").fadeIn(800);

        } else if (checkText(checkThisText, 'go') && checkText(checkThisText, 'west') && mooseStatus === "unseen") {

            $(".big-text").hide().html("You mosey on over to the door to the <em>west</em>. The door is unlocked so you " +
                "open it up. In the next room you see a monstrosity. There is a hulking creature on the far side of the " +
                "room. You have heard tales of the <em>Dire Moose</em> but you didn't think they were real. You feel true " +
                "terror as the <em>Dire Moose</em>'s solid black eyes meet your own. The <em>Dire Moose</em> unleashes a " +
                "roar that makes you realize how truly insignificant you are. It charges towards you at a speed that " +
                "should be impossible for a creature it's size. You close the door.").fadeIn(800);

            mooseStatus = "seen";

        } else if (checkText(checkThisText, 'go') && checkText(checkThisText, 'west') && mooseStatus === "seen") {

            $(".big-text").hide().html("How about you don't do that? You really need to find a way to deal with the " +
                "<em>Dire Moose</em>.").fadeIn(800);

        } else if (checkText(checkThisText, 'look') && checkText(checkThisText, 'head') && (earringsStatus === "unseen" || earringsStatus === "seen")) {

            $(".big-text").hide().html("The shrunken <em>head</em> is exactly what you think it is. It's icky and it's " +
                "suspended from a rope that comes down from the ceiling and is tied to it's hair. It is wearing a pretty " +
                "sweet set of hoop <em>earrings</em>. You are thinking of naming him Frank").fadeIn(800);

            earringsStatus = "seen";

        } else if (checkText(checkThisText, 'get') && checkText(checkThisText, 'head')) {

            $(".big-text").hide().html("You grab the <em>head</em> and try to <em>get</em> it. The fact that the head is " +
                "tied to the ceiling is preventing this.").fadeIn(800);
        ...
        } else if (checkText(checkThisText, 'look') && checkText(checkThisText, 'earrings') && earringsStatus === "seen") {

            $(".big-text").hide().html("The <em>earrings</em> are the only ornamentation that the <em>head</em> has. " +
                "They are large, circular and appear to be made out of gold.").fadeIn(800);

        } else if (checkText(checkThisText, 'use') && checkText(checkThisText, 'earrings') && earringsStatus === "seen") {

            $(".big-text").hide().html("No. You can't do that. They are still attached to the <em>head</em>.").fadeIn(800);

        } else if (checkText(checkThisText, 'get') && checkText(checkThisText, 'earrings') && earringsStatus === "seen") {

            $(".big-text").hide().html("You take off one of the earrings. As a captive of Emperor Leslie, this holds no " +
                "value to you as an earring. It would probably make a great fishing <em>hook</em>.").fadeIn(800);
        ...
        } else if (checkText(checkThisText, 'look') && checkText(checkThisText, 'head') && earringsStatus === "gotten") {

            $(".big-text").hide().html("It's the same head but with no earrings.").fadeIn(800);

        } else if ((checkText(checkThisText, 'look') || checkText(checkThisText, 'get')
            || checkText(checkThisText, 'go') || checkText(checkThisText, 'use')) &&
            checkText(checkThisText, 'podium')) {
            ...
            $(".big-text").hide().html("This obviously has some kind of magical power. You do some quick detective work " +
                "and deduce that the explosion you heard came from this <em>staff</em>. All surfaces radiating from " +
                "around the staff are charred black. It is made from a fine polished wood, etched with runes and topped " +
                "with a diamond.").fadeIn(800);
            ...
            $(".big-text").hide().html("You gingerly lift the <em>staff</em> off of the ground. Huh. This feels a lot " +
                "like holding your old fishing pole. You know, the one you never used when your father never took you " +
                "fishing. Yeah, that one.").fadeIn(800);
            ...
            $(".big-text").hide().html("There are good ideas and bad ideas. Using a fishing pole to try and catch a " +
                "<em>Dire Moose</em> will go down in history as the most poorly thought out plan that has ever been " +
                "conceived by arguably intelligent life.").fadeIn(800);
            ...
            $(".big-text").hide().html("You are in a room with a bare stone floor and the <em>wall</em>s are covered in " +
                "some kind of symbols. All things considered, this place doesn't seem too bad. The epicenter of dark " +
                "magic is sparsely furnished. The only really disturbing thing in here is a shrunken <em>head</em> that " +
                "is hanging from the ceiling. The center of the room is clear and you are standing in a red <em>circle</em> " +
                "painted on the ground. There is a <em>podium</em> facing towards you. Near the <em>podium</em> a <em>staff</em> " +
                "is laying on the ground and the area surrounding the <em>staff</em> is blackened. The directions leading " +
                "out are <em>east</em> and <em>west</em>. There is a <em>TBD barrier</em> to the <em>north</em> and " +
                "<em>south</em>.").fadeIn(800);
        ...
        } else if (checkText(checkThisText, 'fish') && checkText(checkThisText, 'circle') && fishingPoleStatus === "combined") {
            $(".big-text").hide().html("What do you know, it was a magical pole all along, who would've thought. Out of " +
                "the floor comes a key, but it's covered in some sort of red gooey substance. Thanks dad.").fadeIn(800);
            eastKeyStatus = "gotten";
            removeItemAndCommand("Fishing Pole", "Fish");
            addNewItem("Red Gooey Key");
        } else if (checkText(checkThisText, 'look') && checkText(checkThisText, 'east') && inventory.includes('Red Gooey Key')) {

            $(".big-text").hide().html("You fiddle with the lock a little bit. After a few minutes of fiddling and swearing " +
                "to yourself, you hear a click. The giant door slowly swings open followed by a loud creaking sound. You " +
                "enter the very dimly lit room, change to start things feel but. ").fadeIn(800);
        }
    }
